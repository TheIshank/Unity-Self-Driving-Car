...
public class GeneticManager : MonoBehaviour
{
    ...
    public void StartTheGenetationTest()
    {
        for (int i = 0; i < PopulitionSize; i++)
        {
            ...
            Populition[i].Prefab = Instantiate(CarPrefab, new Vector3(-4, 0.035f, -1.54f), new Quaternion(0, 0, 0, 0));
